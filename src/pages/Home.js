...
function Home() {
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("section", { className: 'pt-24 pb-72 px-10 md:px-40 bg-primary text-white text-center' },
            react_1.default.createElement("h2", { className: 'md:text-4xl text-2xl mb-6 font-bold' }, "Hi, my name is Emmanuel."),
        ...
        react_1.default.createElement("section", { className: '-mt-40 bg-white w-[90%] mx-auto rounded-xl p-4 shadow-md shadow-slate-300' },
            react_1.default.createElement("div", { className: "column pt-10 text-center" },
                ...
                react_1.default.createElement("div", { className: 'p-10' },
                    ...
                    react_1.default.createElement("p", { className: 'm-4' }, "I deploy and manage infrastructure with Terraform, configure systems with Ansible, and troubleshoot production issues on Linux and Windows. I work with cloud providers and containerization tools like Docker and Kubernetes to implement scalable solutions for your Applications and Services."),
                    react_1.default.createElement("p", { className: "list-title text-primary mt-4" }, "Skills:"),
