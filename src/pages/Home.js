    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", { className: "h-screen p-7 text-text" },
            react_1.default.createElement("div", { className: 'flex w-full justify-end py-3' },
                react_1.default.createElement("a", { href: 'mailto:dejanaemzy37@gmail.com' },
            ...
            react_1.default.createElement("div", { className: 'py-10 flex justify-center' },
                react_1.default.createElement("section", { className: 'py-5', id: 'content' },
                    ...
                    react_1.default.createElement("a", { href: "https://docs.google.com/document/d/13ncIiODovsmSfxzmQyAfqi0w-5kWrCvEvX9Z8CAvXLQ/", target: '_blank', className: 'mx-auto w-max flex justify-center', rel: "noreferrer" },
        ...
        react_1.default.createElement("footer", { className: 'bg-primary text-white py-24  flex-column justify-center items-center' },
            ...
            react_1.default.createElement("div", { className: "social-icons" },
                react_1.default.createElement("p", { className: "field" },
                    react_1.default.createElement("a", { className: "button is-medium", href: "https://twitter.com/janor_", target: "_blank", rel: "noreferrer" },
                        react_1.default.createElement("span", { className: "icon is-small" },
                            ...
                            " ")),
                    react_1.default.createElement("a", { className: "button is-medium", href: "https://www.linkedin.com/in/emmanuelaladejana/", target: "_blank", rel: "noreferrer" },
                        react_1.default.createElement("span", { className: "icon is-small" },
                            ...
                            " ")),
                    react_1.default.createElement("a", { className: "button is-medium", href: "mailto:dejanaemzy37@gmail.com" },
                        react_1.default.createElement("span", { className: "icon is-small" },
