...
function Home() {
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("section", { className: 'pt-24 pb-72 px-40 bg-primary text-white text-center' },
            react_1.default.createElement("h2", { className: 'text-4xl mb-6 font-bold' }, "Hi, my name is Aladejana."),
            react_1.default.createElement("p", { className: ' text-xl' }, "I'm a passionate Cloud DevOps Engineer, constantly innovating to streamline software delivery with scalable infrastructure solutions. I thrive on troubleshooting complex systems, ensuring cloud environments are secure and reliable, and automating deployments with Terraform and Ansible. Excellent communication skills are my secret weapon for sharing and receiving ideas and solutions.")),
        ...
        react_1.default.createElement("section", { className: 'mt-8 ' },
            ...
            react_1.default.createElement("div", { className: 'flex justify-center flex-wrap gap-4 -mt-24' }, data.map((data) => react_1.default.createElement(Card_1.default, { title: data.title, text: data.text, link: data.link, svgs: data.svgs })))),
        ...
        react_1.default.createElement("footer", { className: 'bg-primary text-white py-24 max-w-[1200px] flex-column justify-center items-center' },
            react_1.default.createElement("p", { className: 'opacity-[0.8] text-2xl p-10' }, "Living, learning, & leveling up one day at a time."),
