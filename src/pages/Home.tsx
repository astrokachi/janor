         ...
         <div className="h-screen p-7 text-text">
            ...
            <div className='py-10 flex justify-center'>
               <section className='py-5' id='content'>
                  ...
                  {/* Link to resume */}
                  <a href="https://" className='mx-auto w-max flex justify-center'>
         ...
         <footer className='bg-primary text-white py-24  flex-column justify-center items-center'>
            ...
            <div className="social-icons">
               <p className="field">
                  ...
                  <a className="button is-medium" href="https://twitter.com/" target="_blank" rel="noreferrer">
                  ...
                  <a className="button is-medium" href="https://linkedin.com/in/" target="_blank" rel="noreferrer">
