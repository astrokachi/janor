...
function Home() {
   ...
   return (
      <div>
         <div className="h-screen p-7 text-text">
            <div className='flex w-full justify-end py-3'>
               <a href='mailto:dejanaemzy37@gmail.com'>
                  <button className="border-primary font-lato border-2 text-primary text-xl h-11 px-4 rounded-[9999px] hover:bg-primary hover:text-white">Send a mail</button>
               </a>
            ...
            <div className='py-10 flex justify-center'>
               <section className='py-5' id='content'>
                  <h1 className='text-center pt-5 pb-2 text-text font-bold text-5xl'>Cloud DevOps Engineer</h1>
                  <p className='text-2xl py-6 text-center'>I bring the power of the cloud to your fingertips through expertly crafted automation services.</p>
                  {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}

                  {/* Link to resume */}
                  <a href="https://docs.google.com/document/d/13ncIiODovsmSfxzmQyAfqi0w-5kWrCvEvX9Z8CAvXLQ/" target='_blank' className='mx-auto w-max flex justify-center' rel="noreferrer">
                     <button className="border-primary font-lato border-2 text-primary text-xl h-11 px-4 rounded-[9999px] hover:bg-primary hover:text-white">My resume</button>
                  </a>
                  <div className='w-full flex justify-center pt-8 pb-2'>
                     <img src={require("../assets/avatar.svg").default} alt="logo" />
                  </div>
         ...
         <section className='p-7 pb-1'>
            <div className='px-56'>
               <img src={require("../assets/hero-devices.svg").default} alt="hero" />
            </div>
         </section>
         ...
         <section className='text-center mt-32 mb-20 flex-column justify-center items-center gap-5'>
            ...
            <a href="mailto:dejanaemzy37@gmail.com">
               <button onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)} className="border-primary mt-10  flex w-max items-center font-lato border-2 gap-3 text-primary text-xl h-11 px-5 rounded-[9999px] hover:bg-primary hover:text-white">
                  <div className='w-6 h-5  transition-all delay-100'>
                     ...
                     <img className={`absolute w-6 transition-all delay-[50ms] ${isHover ? '-z-10' : 'z-10'}`} src={require('../assets/conversation-svgrepo-com.svg').default} alt="" />
         ...
         <footer className='bg-primary text-white py-24  flex-column justify-center items-center'>
            ...
            <div className="social-icons">
               <p className="field">
                  ...
                  <a className="button is-medium" href="https://twitter.com/janor_" target="_blank" rel="noreferrer">
                     <span className="icon is-small">
                        <svg className="svg-inline--fa fa-twitter fa-fw" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        </svg><i className="fab fa-twitter fa-fw"></i> </span></a>

                  {/* insert link to linkedin */}
                  <a className="button is-medium" href="https://www.linkedin.com/in/emmanuelaladejana/" target="_blank" rel="noreferrer">
                     <span className="icon is-small"><svg className="svg-inline--fa fa-linkedin-in fa-fw" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path></svg><i className="fab fa-linkedin-in fa-fw"></i> </span></a>


                  {/* insert link to email */}
                  <a className="button is-medium" href="mailto:dejanaemzy37@gmail.com"><span className="icon is-small"><svg className="svg-inline--fa fa-envelope fa-fw" aria-hidden="true" focusable="false" data-prefix="far" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z"></path></svg><i className="far fa-envelope fa-fw"></i> </span></a></p>
            </div>
         </footer>
      </div>
   )
